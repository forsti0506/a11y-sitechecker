...
//         executeLogin('http://www.forsti.eu', (await browser.pages())[0], config).then((retCode) =>
...
//         ];
//
//         await executeLogin('http://www.forsti.eu', (await browser.pages())[0], config).catch((err) => {
...
//         ];
//
//         await executeLogin('http://www.forsti.eu/wp-admin', (await browser.pages())[0], config).then((r) => {
//             expect(r).toBe(1);
//             done();
//         });
//     });
